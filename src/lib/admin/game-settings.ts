...
export async function getAdminGameSettingsState() {
  ...
  return {
    ...
    games: games.map((game) => ({
      ...
      moneyUnitNameKo: game.moneyUnitNameKo,
      moneyUnitNameCn: game.moneyUnitNameCn,
      moneyUnitNameVn: game.moneyUnitNameVn,
      moneyUnitNamePh: game.moneyUnitNamePh,
      moneyUnitNameTh: game.moneyUnitNameTh,

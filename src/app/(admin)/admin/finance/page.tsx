      ...
      <section className="mx-auto flex max-w-7xl flex-col gap-6">
        ...
        <section className="grid gap-4 lg:grid-cols-[1fr_1fr_auto]">
          ...
          <div className="rounded-lg border border-slate-200 bg-white p-4 shadow-sm">
            <p className="text-xs font-black uppercase tracking-[0.18em] text-[var(--color-primary)]">NEXT</p>
            <p className="mt-2 text-lg font-black">{nextAction.title}</p>
            <Link
              href={nextAction.href}
              className="mt-4 inline-flex w-full justify-center rounded-md bg-slate-950 px-4 py-2 text-sm font-black text-white hover:bg-slate-800"
            >

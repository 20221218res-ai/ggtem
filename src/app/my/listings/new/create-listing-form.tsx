  ...
  return (
    <form onSubmit={handleSubmit} className="grid gap-5 lg:grid-cols-[1fr_340px]">
      ...
      <aside className="space-y-4 lg:sticky lg:top-4 lg:self-start">
        ...
        <div className="grid gap-2">
          <button
            type="button"
            onClick={openFinalReview}
            disabled={isSubmitting || !hasSelectableCatalog || flowStep < 4}
      ...
      <FinalReviewModal
        ...
        description={t("listingForm.sellFinalReviewDescription")}
        rows={finalSummaryRows}
        confirmLabel={isSubmitting ? t("listingForm.creating") : t("listingForm.createSell")}

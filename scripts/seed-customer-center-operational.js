...
const VERSION = "2026-05-10-operational";
...
const documents = [
  {
    ...
    body: [
      ...
      "구매자가 즉시구매 또는 판매자가 즉시판매를 시작하면 거래 금액은 먼저 에스크로로 잠기며, 인수확정 또는 거래 완료 이후 판매자에게 정산됩니다.",
      "거래 중에는 주문 채팅을 통해 전달 내역을 남겨 주세요. 분쟁이 발생하면 관리자가 주문 내역, 채팅, 에스크로 상태를 함께 확인합니다.",
      "외부 연락처 교환이나 외부 결제 유도는 제재 대상이며, 피해 발생 시 플랫폼 보호를 받기 어렵습니다.",
    ].join("\n\n"),
  },
  {
    ...
    body: [
      ...
      "출금은 최소 20 USDT부터 신청할 수 있으며, 하루 최대 2회와 4시간 쿨타임 정책이 적용됩니다.",
  ...
  },
  {
    ...
    body: [
      ...
      "계정 거래의 계정 정보 전달은 주문 내 전용 입력/확인 절차를 사용해 주세요.",
    ].join("\n\n"),
  },
  {
    ...
    title: "충전은 어떻게 하나요?",
    body: [
      "마이페이지 또는 지갑에서 충전 메뉴를 선택한 뒤 TRC20 또는 BEP20 네트워크와 충전 금액을 입력합니다.",
  ...
  },
  {
    ...
    body: [
      ...
      "최근 24시간 내 성공 거래 1건 이상 또는 최근 7일 누적 거래 20 USDT 이상 조건을 충족해야 합니다.",
  ...
  },
  {
    ...
    body: [
      "계정 거래는 결제와 에스크로 잠금이 완료된 뒤 판매자가 주문 내 계정 정보 전달 절차를 통해 계정과 비밀번호를 입력합니다.",
  ...
  },
  {
    ...
    body: [
      "주문 상세에서 분쟁 접수를 진행하면 관리자가 주문 상태, 지갑 내역, 채팅 기록을 확인합니다.",
      "분쟁 중인 거래가 있으면 출금이 제한될 수 있습니다.",
      "외부 연락처로 진행된 대화나 플랫폼 밖 결제는 확인이 어렵기 때문에 반드시 주문 채팅 안에서 거래 내용을 남겨 주세요.",
    ].join("\n\n"),
  },
  {
    ...
    body: [
      ...
      "외부 결제, 직접 송금, 플랫폼 수수료 회피, 거래 유도 문구도 제재 대상입니다.",
  ...
  },
  {
    ...
    body: [
      ...
      "계정 정보는 결제와 에스크로 잠금 이후 주문 내 전용 전달 절차를 통해 입력해야 합니다.",
      "거래 완료 전 연락처 교환, 외부 화면 공유, 외부 결제 요구는 금지됩니다.",
      "계정 회수, 허위 정보, 2차 인증 미고지 등 구매자 피해를 유발하는 행위는 강한 제재 대상입니다.",
    ].join("\n\n"),
  },
  {
    ...
    body: [
      "프리미엄 상위 노출은 글 목록에서 일반글보다 먼저 보이도록 도와주는 유료 기능입니다.",
      "30시간 단위로 이용할 수 있으며, 기간이 끝나면 자동으로 일반 노출로 전환됩니다.",
      "프리미엄 글이 거래 완료되거나 판매/구매가 종료되면 남은 시간과 관계없이 노출이 종료됩니다.",
  ...
  },
  {
    ...
    title: "신규 게임 및 서버 신청 안내",
    body: [
      "원하는 게임이나 서버가 목록에 없을 경우 고객센터의 신규 게임 / 서버 신청 메뉴를 통해 요청할 수 있습니다.",
      "게임명, 서버명, 국가, 거래 가능한 카테고리 정보를 함께 남겨 주시면 검토가 빨라집니다.",
      "운영팀 검토 후 등록 가능 여부와 적용 시점을 안내합니다.",
    ].join("\n\n"),
  },
];
